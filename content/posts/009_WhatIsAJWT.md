...
As you enter your credit card info, you remember that HTTP (the way you interact with websites) is stateless. That's a fancy way of saying the website doesn't keep an ongoing connection with your web browser. Everytime you interact with the site, you need to tell the web server who you are... but you somehow don't need to give your username and password every time you click another button on the site. 
...
Here's how the token creation works: 

1. The server creates a header, like the one in our example above.
1. The server base-64 encodes the header and payload, and combines them with a dot (`.`). 
...
JWTs are amazing. Many websites silently send them to you as you go about your day. The next time you're ordering your midnight snack, order some for me. 