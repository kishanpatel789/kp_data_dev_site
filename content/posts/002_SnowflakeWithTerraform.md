...
`source .env`. This will load the Snowflake service user password you used into the environment. Remember, we don't want to commit the hard-coded password into the codebase. 
